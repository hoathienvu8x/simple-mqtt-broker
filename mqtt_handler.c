...
ssize_t MQTT_handle_connect(uint8_t *response) {
  ...
  uint8_t conn_ack_message[] = {
    CONNACK << 4, remaining_length,
...
ssize_t get_subscribe_ack(uint16_t msg_id, uint8_t *response) {
  ...
  uint8_t subscribe_ack_message[] = {
    SUBACK << 4, remaining_length,
    msg_id_1, msg_id_2,
...
ssize_t get_unsubscribe_ack(uint16_t msg_id, uint8_t *response) {
  ...
  uint8_t unsubscribe_ack_message[] = {
    UNSUBACK << 4, remaining_length,
    msg_id_1, msg_id_2,
